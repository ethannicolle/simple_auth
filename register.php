...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($username && $password) {
        ...
        if(strlen($password) < MIN_USERNAME_LENGTH || strlen($password) > MAX_USERNAME_LENGTH) $errors[] = 'Password must contain between ' . MIN_USERNAME_LENGTH . ' and ' . MAX_USERNAME_LENGTH . ' characters.';
